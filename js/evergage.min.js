...
(function configureEvergage() {
    try {
       Evergage.configure({
           ...
           trackerUrl: "https://unicefusa2.us-5.evergage.com",
           siteConfigVersion: "31"
       },{"allowBotTraffic":false,"corsAllowedOrigins":["*"],"defaultCurrency":"USD","defaultLocale":null,"disableQtipWindowScroll":false,"doNotStoreCookiesRequireProvidedAnonId":false,"doNotTrackPingRequestsForActions":false,"enableCorsRestrictedOrigins":false,"enableMessageRotation":false,"enableRememberMeUserIds":false,"enableTemplateEsc":false,"hideContentSections":false,"hideContentSectionsMillis":2500,"hidePagesForRedirect":false,"hidePagesForRedirectMillis":1000,"identityAttributes":["customerId","emailAddress","profileId","sfmcContactKey"],"lastModified":1637601320235,"preventSensitiveDataCapture":false,"rememberMeUserIdsMillis":63072000000,"secureCookie":false,"sendErrorEvents":true,"showPoweredBy":false,"siteConfigExecBeforePageReady":false,"spaRouteChangeTimeout":500,"trackAnonymousVisitors":true,"trackContextualRelatedItems":false,"trackSubdomainAsCompany":false,"trackUnknownPagesByTitle":false,"treatHashChangeAsPageLoad":false}       );
    } catch (e) {
          console.error(e);
    }
})();
...
const getCookieDomain = () => {
    ...
    if (currentDomain.includes("unicefusa.org")) {
        return "unicefusa.org"
    }
    else {
        return "live-unicefusa2022.pantheonsite.io"
    }
}
SalesforceInteractions.init({
    ...
    //  if (clickedElement.getAttribute("value") == "Submit") {
    //      const email = SalesforceInteractions.cashDom(".form-email").val();
    ...
    const sitemapConfig = {
        global: {
            listeners: [
                SalesforceInteractions.listener("click", "aside > div > div > div > div:nth-of-type(2) > div > form > div:nth-of-type(4) > input.webform-button--submit", (event) => {
                    const email = SalesforceInteractions.cashDom("aside > div > div > div > div:nth-of-type(2) > div > form > div:nth-of-type(3) > input").val();
                    console.log(email)
                    const emailSignup = SalesforceInteractions.cashDom(event.currentTarget);
                    if (emailSignup) {
                        SalesforceInteractions.sendEvent({
                            interaction: {
                ...
                SalesforceInteractions.listener("click", "body > div:nth-of-type(2) > header > div > div:nth-of-type(3) > div:nth-of-type(1) > div > form > div:nth-of-type(4) > input", (event) => {
                    const email = SalesforceInteractions.cashDom("body > div:nth-of-type(2) > header > div > div:nth-of-type(3) > div:nth-of-type(1) > div > form > div:nth-of-type(3) > input").val();
                    const emailSignup = SalesforceInteractions.cashDom(event.currentTarget);
                    if (emailSignup) {
                        SalesforceInteractions.sendEvent({
                            interaction: {
                ...
                SalesforceInteractions.listener("click", "#block-utilitymenu > ul > li:nth-child(1) > a", (event) => {
                    const shop = SalesforceInteractions.cashDom(event.currentTarget);
                    if (shop) {
                        SalesforceInteractions.sendEvent({
                            interaction: {
                                name: "Shop",
                ...
                SalesforceInteractions.listener("click", "#block-utilitymenu > ul > li:nth-child(2) > a", (event) => {
                    const signIn = SalesforceInteractions.cashDom(event.currentTarget);
                    if (signIn) {
                        SalesforceInteractions.sendEvent({
                            interaction: {
                                name: "Sign in",
                ...
                SalesforceInteractions.listener("submit", "#views-exposed-form-search-block-1", (event) => {
                    const search = SalesforceInteractions.cashDom(event.currentTarget);
                    if (search) {
                        SalesforceInteractions.sendEvent({
                            interaction: {
                                name: "Search",
        ...
        pageTypes: [
            ...
            },
            {
                name: "Mission",
                isMatch: () => {
                    if (window.location.pathname.includes("what-unicef-does")) {
                        return (document.querySelector(".breadcrumb").childNodes[3].childElementCount === 3) && (window.location.pathname.includes("what-unicef-does"))
                    }
                    else {
                        return false
                    }
                ...
                interaction: {
                    ...
                    catalogObject: {
                        type: "Missions",
                        id: () => {
                            if (SalesforceInteractions.cashDom("h1 >.field--name-title")[0]) {
                                return SalesforceInteractions.cashDom("h1 >.field--name-title")[0].innerText.replace("\n", " ").toUpperCase()
                            }
                        },
                        attributes: {
                            name: () => {
                            ...
                            description: () => {
                                if (SalesforceInteractions.cashDom(".hero-mission__content")[0].children[1]) {
                                    return SalesforceInteractions.cashDom(".hero-mission__content")[0].children[1].innerText
                                }
                            },
                            url: () => {
                            ...
                            imageUrl: () => {
                                let image = SalesforceInteractions.cashDom(".media--view-mode--hero > picture > img")[0].getAttribute("src");
                                if(image.includes(window.location.host)){
                                    return image
                                }
                                 return "https://" + window.location.host.concat(SalesforceInteractions.cashDom(".media--view-mode--hero > picture > img")[0].getAttribute("src")) },
                        },
                        relatedCatalogObjects: {
                            MissionCategory: () => {
                                if (SalesforceInteractions.cashDom(".breadcrumb")[0].children[1].children[2]) {
                                    return [SalesforceInteractions.cashDom(".breadcrumb")[0].children[1].children[2].innerText.toUpperCase()]
                                }
                            }
                        },
            ...
            },
            {
                ...
                isMatch: () => {
                    return window.location.pathname.includes("what-unicef-does")
                },
                interaction: {
                    name: SalesforceInteractions.CatalogObjectInteractionName.ViewCatalogObject,
                    catalogObject: {
                        ...
                        attributes: {
                            ...
                            imageUrl: () => { return window.location.host.concat(SalesforceInteractions.cashDom(".media--view-mode--hero > picture > img")[0].getAttribute("src")) }
                        }
                    }
                },
            ...
            },
            {
                ...
                isMatch: () => {
                    return window.location.pathname.includes("careers")
                }
            },
            {
                name: "Diversity",
                ...
                isMatch: () => {
                    return window.location.pathname.includes("diversity-racial-equity-belonging")
                }
            },
            {
                name: "Finances",
                ...
                isMatch: () => {
                    return window.location.pathname.includes("finances")
                }
            },
            {
                name: "Fundraise",
                ...
                isMatch: () => {
                    return window.location.pathname.includes("fundraise")
                }
            },
            {
                name: "USA Leadership",
                ...
                isMatch: () => {
                    return window.location.pathname.includes("leadership")
                }
            },
            {
                name: "Partnerships",
                ...
                isMatch: () => {
                    return window.location.pathname.includes("partnerships")
                }
            },
            {
                name: "UNICEF USA and UNICEF",
                interaction: {
                    name: "UNICEF USA and UNICEF"
                },
                isMatch: () => {
                    return window.location.pathname.includes("unicef-usa-and-unicef")
                }
            },
            {
                name: "Advocate",
                ...
                isMatch: () => {
                    return window.location.pathname.includes("advocate")
                }
            },
            {
                name: "Donate",
                ...
                isMatch: () => {
                    return window.location.pathname.includes("donate")
                }
            },
            {
                name: "Ways to give",
                ...
                isMatch: () => {
                    return window.location.pathname.includes("ways-give")
                }
            },
            {
                name: "Search results",
            ...
            },
            {
                ...
                isMatch: () => {
                    return window.location.pathname.includes("stories") && (document.getElementsByClassName("hero-story__content").length !== 0)
                }
            },
            {
                name: "UNICEF in action",
                interaction: {
                    name: "Stories"
                },
                isMatch: () => {
            ...
            },
            {
                ...
                isMatch: () => {
                    return window.location.pathname.includes("press")
                }
            },
            {
                name: "Privacy policy",
            ...
            {
                name: "SMS privacy statement",
                interaction: {
                    name: "SMS privacy statement"
                },
                isMatch: () => {
                    return window.location.pathname.includes("sms-privacy-statement")
                }
            },
            {
                name: "Terms of Use",
                ...
                isMatch: () => {
                    return window.location.pathname.includes("terms-use")
                }
            },
            {
                name: "Linking agreement",
                interaction: {
                    name: "Linking agreement"
                },
                isMatch: () => {
                    return window.location.pathname.includes("linking-agreement")
                }
            },
            {
                name: "FAQ",
                ...
                isMatch: () => {
                    return window.location.pathname.includes("faq")
                }
            },
        ],
    };
...
FundraiseUp.on('checkoutOpen', function (details) {
    //console.log('IS captured checkout open');
    //console.log (details.campaign.name);      
    //console.log(details);
    var lineItem = {
        _id: details.campaign.name,
        price: 1,
        quantity: 1,
    };
    Evergage.sendEvent({
        action: "Donation Opened",
    ...
    //console.log('event send for checkout open')
});
FundraiseUp.on('checkoutClose', function (details) {
    SalesforceInteractions.sendEvent({
        action: "Donation Canceled",
        catalog: {
            Product: {
                _id: details.campaign.name,
                name: details.campaign.name,
...
FundraiseUp.on('donationComplete', function (details) {
    //   console.log('IS captured donationComplete ');
    //   console.log(details);

    var fullname = details.supporter.firstName + ' ' + details.supporter.lastName;
    SalesforceInteractions.sendEvent({
        action: "Donation Completed",
        itemAction: 'Purchase',
        order: {
            Product: {
                orderId: details.donation.id,
                totalValue: details.donation.amount,
                lineItems: [{
                    id: details.campaign.name,
        ...
        user: {
            attributes: {
                fullName: fullname,
                emailAddress: details.supporter.email,
                userName: details.supporter.email,
            }
        }
    });
});
